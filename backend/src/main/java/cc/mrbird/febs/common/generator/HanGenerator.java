...
public class HanGenerator {
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/gyjsapi?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    public static void main(String[] args) {
        ...
        //"cross_stage","dic_yp","dic_zl","gfjs_zzd","hk_xh_common_rule","hk_xh_spec_rule","hospital_balance","hospital_detail_tmp","hospitals","out_hospital_info","receipt_balance_item","receipt_balance_sum","receipt_call_log","receipt_item","receipt_rolls","template_rule","zzd_daily_sum"
        strategy.setInclude(new String[]{"data_catalog","drug_enter_record"}); // 需要生成的表
